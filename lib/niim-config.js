 ...
 * @param    cloptFilename       {string}       The niim --config= option argument
 * @returns  the configuration object
 */
exports.init = function niimConfig$$init(debuggeeFilename, cloptFilename) {
  var config = {};
  var sandbox = {
    process: {
