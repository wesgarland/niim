...
exports.recordHistory = function nimm$recordHistory(repl) {
  ...
  if (debuggerState.innerREPLHistory === debuggerState.outerREPLHistory === 0)
    return;
...
function loadHistory() {
  ...
  console.log('read history:', config.programName, debuggerState.outerREPLHistory.length, debuggerState.innerREPLHistory.length);
}
