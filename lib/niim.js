...
let debuggerState = { process: {}, child: {}, signals: {}, repl: {} };
...
exports.type = async function() {
  ...
  try {
    ...
    console.log('| entering interactive terminal mode,', quitHow, 'to exit');
...
function restoreEvents(backup, eventEmitter, eventNames) {
  ...
  for (let eventName of (eventNames || Object.keys(backup))) {
    console.log('restoring eventName', eventName);
